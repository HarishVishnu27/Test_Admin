    ...
    def analyze_and_save(self, frame, result):
        ...
        if result is not None:
            try:
                ...
                # Update VDC: Set to True (1) when vehicles are LESS THAN 2
                vdc = 0 if r1_vehicles < 3 else 1
...
def update_regions():
    try:
        ...
        if cam_id and new_regions:
            ...
            return jsonify({'status': 'success', 'message': 'Regions updated successfully'}), 200
